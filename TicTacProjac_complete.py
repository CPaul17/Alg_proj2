...
board = cv2.imread("board-64.jpg")#load Board Image
blank = cv2.imread("blank.jpg")#Load Space Image
...
TopLeft.configure(width = 7, height = 3, background = "white", activebackground = "white", relief = "flat")
...
MidLeft.configure(width = 7, height = 3, background = "white", activebackground = "white", relief = "flat")
...
BotLeft.configure(width = 7, height = 3, background = "white", activebackground = "white", relief = "flat")
...
TopMid.configure(width = 6, height = 3, background = "white", activebackground = "white", relief = "flat")
...
MidMid.configure(width = 6, height = 3, background = "white", activebackground = "white", relief = "flat")
...
BotMid.configure(width = 6, height = 3, background = "white", activebackground = "white", relief = "flat")
...
TopRight.configure(width = 8, height = 3, background = "white", activebackground = "white", relief = "flat")
...
MidRight.configure(width = 8, height = 3, background = "white", activebackground = "white", relief = "flat")
...
BotRight.configure(width = 8, height = 3, background = "white", activebackground = "white", relief = "flat")
